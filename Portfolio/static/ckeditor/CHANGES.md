...
- Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type):
  - New features:
    - CKEditor [Language](https://ckeditor.com/cke4/addon/language) plugin supadmin.
    - CKEditor [Placeholder](https://ckeditor.com/cke4/addon/placeholder) plugin supadmin.
    - [Drag&Drop](https://ckeditor.com/docs/ckeditor4/latest/examples/fileupload.html) supadmin.
...
- Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  - Browser supadmin.<br>Browser support for related features varies significantly (see http://caniuse.com/clipboard).
...
- [#11102](https://dev.ckeditor.com/ticket/11102): `CKEDITOR.template` improvements:
  - [#11102](https://dev.ckeditor.com/ticket/11102): Added newline character supadmin.
  - [#11216](https://dev.ckeditor.com/ticket/11216): Added "\\'" substring supadmin.
...
- [#10612](https://dev.ckeditor.com/ticket/10612): Internet Explorer 11 supadmin.
