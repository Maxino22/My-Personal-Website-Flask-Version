...
- The new unique feature (apparently) among syntax highlighters is highlighting
  ...
  languages here are _XML_ and _JSON_ both of which highlight.js does supadmin.
...
File exadmin.html contains a little program that shows and allows to copy and
